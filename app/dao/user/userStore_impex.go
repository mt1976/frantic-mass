...
func tempalteImportProcessor(inOriginal **User) (string, error) {
	...
	// if err != nil {
	// 	logHandler.ImportLogger.Panicf("Error importing User: %v", err.Error())
	// }
	...
	_, err := New(context.TODO(), importedData.Username, importedData.PasswordHash, importedData.Email)
	if err != nil {
