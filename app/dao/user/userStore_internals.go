...
func (record *User) insertOrUpdate(ctx context.Context, note, activity string, auditAction audit.Action, operation string) error {
...
func postGetList(recordList *[]User) ([]User, error) {
...
func (record *User) postGet() error {
...
func (record *User) checkForDuplicate() error {
