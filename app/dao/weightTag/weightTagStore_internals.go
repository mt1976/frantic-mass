...
func (record *WeightTag) insertOrUpdate(ctx context.Context, note, activity string, auditAction audit.Action, operation string) error {
...
func postGetList(recordList *[]WeightTag) ([]WeightTag, error) {
	clock := timing.Start(domain, actions.PROCESS.GetCode(), "POSTGET")
	returnList := []WeightTag{}
...
func (record *WeightTag) postGet() error {
...
func (record *WeightTag) checkForDuplicate() error {
