...
/// DO NOT CHANGE THIS FILE OTHER THAN TO RENAME "weightTag" TO THE NAME OF THE DOMAIN ENTITY
/// DO NOT CHANGE THIS FILE OTHER THAN TO RENAME "weightTag" TO THE NAME OF THE DOMAIN ENTITY
/// DO NOT CHANGE THIS FILE OTHER THAN TO RENAME "weightTag" TO THE NAME OF THE DOMAIN ENTITY
...
func (record *weightTag_Store) insertOrUpdate(ctx context.Context, note, activity string, auditAction audit.Action, operation string) error {
...
func postGetList(recordList *[]weightTag_Store) ([]weightTag_Store, error) {
	clock := timing.Start(domain, actions.PROCESS.GetCode(), "POSTGET")
	returnList := []weightTag_Store{}
...
func (record *weightTag_Store) postGet() error {
...
func (record *weightTag_Store) checkForDuplicate() error {
