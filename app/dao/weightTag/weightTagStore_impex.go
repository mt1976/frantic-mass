...
func tempalteImportProcessor(inOriginal **weightTag_Store) (string, error) {
	//TODO: Build the import processing functionality for the weightTag_Store data here
	//
	...
	// if err != nil {
	// 	logHandler.ImportLogger.Panicf("Error importing weightTag: %v", err.Error())
	// }
	...
	_, err := New(context.TODO(), importedData.WeightID, importedData.TagID)
	if err != nil {
