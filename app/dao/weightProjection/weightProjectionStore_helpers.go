...
func (record *weightProjection_Store) upgradeProcessing() error {
...
func (record *weightProjection_Store) defaultProcessing() error {
	//TODO: Add any default calculations here
	//This processing is triggered directly before the record is saved to the database
	return nil
}

func (record *weightProjection_Store) validationProcessing() error {
...
func (h *weightProjection_Store) postGetProcessing() error {
...
func (record *weightProjection_Store) preDeleteProcessing() error {
...
func weightProjectionClone(ctx context.Context, source weightProjection_Store) (weightProjection_Store, error) {
	//TODO: Add any clone processing here
	panic("Not Implemented")
	return weightProjection_Store{}, nil
}
...
func weightProjectionJobProcessor(j jobs.Job) {
	...
	for weightProjectionEntryIndex, weightProjectionRecord := range weightProjectionEntries {
		...
		weightProjectionRecord.UpdateWithAction(context.TODO(), audit.GRANT, "Job Processing")
