...
/// DO NOT CHANGE THIS FILE OTHER THAN TO RENAME "weightProjection" TO THE NAME OF THE DOMAIN ENTITY
/// DO NOT CHANGE THIS FILE OTHER THAN TO RENAME "weightProjection" TO THE NAME OF THE DOMAIN ENTITY
/// DO NOT CHANGE THIS FILE OTHER THAN TO RENAME "weightProjection" TO THE NAME OF THE DOMAIN ENTITY
...
func (record *weightProjection_Store) insertOrUpdate(ctx context.Context, note, activity string, auditAction audit.Action, operation string) error {
...
func postGetList(recordList *[]weightProjection_Store) ([]weightProjection_Store, error) {
	clock := timing.Start(domain, actions.PROCESS.GetCode(), "POSTGET")
	returnList := []weightProjection_Store{}
...
func (record *weightProjection_Store) postGet() error {
...
func (record *weightProjection_Store) checkForDuplicate() error {
