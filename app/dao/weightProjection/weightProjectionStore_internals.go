...
func (record *WeightProjection) insertOrUpdate(ctx context.Context, note, activity string, auditAction audit.Action, operation string) error {
...
func postGetList(recordList *[]WeightProjection) ([]WeightProjection, error) {
	clock := timing.Start(domain, actions.PROCESS.GetCode(), "POSTGET")
	returnList := []WeightProjection{}
...
func (record *WeightProjection) postGet() error {
...
func (record *WeightProjection) checkForDuplicate() error {
