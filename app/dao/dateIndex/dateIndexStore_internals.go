...
func (record *DateIndex) insertOrUpdate(ctx context.Context, note, activity string, auditAction audit.Action, operation string) error {
...
func postGetList(recordList *[]DateIndex) ([]DateIndex, error) {
	clock := timing.Start(domain, actions.PROCESS.GetCode(), "POSTGET")
	returnList := []DateIndex{}
...
func (record *DateIndex) postGet() error {
...
func (record *DateIndex) checkForDuplicate() error {
