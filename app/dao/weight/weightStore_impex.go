...
func tempalteImportProcessor(inOriginal **Weight_Store) (string, error) {
	//TODO: Build the import processing functionality for the weight_Store data here
	//
	...
	// if err != nil {
	// 	logHandler.ImportLogger.Panicf("Error importing weight: %v", err.Error())
	// }
	...
	_, err := New(context.TODO(), importedData.UserID, importedData.Weight, importedData.Note, importedData.RecordedAt)
	if err != nil {
