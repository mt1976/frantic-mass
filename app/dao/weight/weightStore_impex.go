...
func tempalteImportProcessor(inOriginal **Weight) (string, error) {
	...
	_, err := Create(context.TODO(), importedData.UserID, importedData.Weight, importedData.Note, importedData.RecordedAt)
	if err != nil {
